    ...
    def read_oct_volume(
        ...
        with open(self.filepath, "rb") as f:
            ...
            for start, pos in chunk_stack:
                ...
                if chunk.type == 3:  # scan preamble data
